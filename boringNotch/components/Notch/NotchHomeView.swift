...
struct MusicPlayerView: View {
    ...
    var body: some View {
        let outerPadding: CGFloat = 10   // left = right = bottom
        let albumSize: CGFloat = 118     // <- ajuste ici si tu veux (88/90/92)
        ...
        .padding(.horizontal, outerPadding) // left = right
        .padding(.vertical, outerPadding)   // top and bottom match -> bottom = left
    }
}
