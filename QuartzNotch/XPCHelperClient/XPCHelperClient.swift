...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "theboringteam.boringnotch.QuartzNotchXPCHelper"
    
    private var remoteService: RemoteXPCService<QuartzNotchXPCHelperProtocol>?
  ...
  // MARK: - Connection Management (Main Actor Isolated)
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<QuartzNotchXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<QuartzNotchXPCHelperProtocol>(
            connection: conn,
            remoteInterface: QuartzNotchXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<QuartzNotchXPCHelperProtocol>? {
        remoteService
    }
  ...
  // MARK: - Monitoring
    nonisolated func startMonitoringAccessibilityAuthorization(every interval: TimeInterval = 8.0) {
        stopMonitoringAccessibilityAuthorization()
