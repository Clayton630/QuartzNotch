    ...
    private func handleCameraTap() {
        ...
        case .denied, .restricted:
            DispatchQueue.main.async {
                ...
                AppLocalizer.localized("Please allow camera access in System Settings to use the mirror feature.")
                alert.addButton(withTitle: AppLocalizer.localized("Open System Settings"))
