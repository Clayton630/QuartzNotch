...
class BatteryStatusViewModel: ObservableObject {
        ...
        case .powerSourceChanged(let pluggedIn):
            if pluggedIn {
                ...
                withAnimation {
                    ...
                    self.statusText = String(localized: "Charging")
                }
        ...
        case .lowPowerModeChanged(let isEnabled):
            withAnimation {
                ...
                self.statusText = String(
                    format: String(localized: "Low Power: %@"),
                    self.isInLowPowerMode ? String(localized: "On") : String(localized: "Off")
                )
            }
    ...
    private func updateBatteryInfo(_ batteryInfo: BatteryInfo) {
        withAnimation {
            ...
            self.statusText = batteryInfo.isPluggedIn ? String(localized: "Charging") : ""
        }
    }
